        ...
        <div className="w-full grid grid-cols-2 gap-10">
          <div>
            <div className="flex flex-col justify-center w-full px-10 py-5">
              <h3 className="text-red-500 font-bold text-lg">Contact With Us</h3>
              <h1 className="text-black font-bold text-4xl py-6">Get in touch</h1>
              <h3 className="text-black font-normal text-sm">Your email address will not be published. Required fields are marked*</h3>
              <form className="mt-20">
                ...
                <div class="mb-6">
                  <div class="relative mt-10">
                    ...
                    <label for="floating_outlined" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Your message</label>
                  </div>
                </div>
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
              </form>
            </div>
          </div>
