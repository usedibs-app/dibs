    ...
    return (
        <div className='mt-10'>
            <div className='w-full bg-gray-300 rounded-xl'>
                <Image src={HeroImage} alt="welcome-to-dibs" className='w-full h-auto'/>
            </div>
                ...
                <div className='grid grid-cols-3 min-h-[100px] gap-10 mt-10'>
                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <div class="px-8 py-10">
                            <div>
                                <h5 class="text-md font-medium tracking-tight text-gray-900 dark:text-white">.April 24, 2021</h5>
                            </div>
                            <div class="mt-3 mb-7">
                                <h5 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">GameStop to Offer Up to $1 Billion in</h5>
                            </div>
                            <div class="flex items-center justify-between border-t-2 border-gray-300 pt-6">
                                <button href="#" class="flex text-black bg-transparent font-medium rounded-lg text-sm px-5 pt-3 text-center">
                                    <span>
                                        Read More
                                    </span>
                                    <span>
